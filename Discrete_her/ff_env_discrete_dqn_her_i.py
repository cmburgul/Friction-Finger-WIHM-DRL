...
class FFEnv(object):
    ...
    def __init__(self):
        ...
        self.ff_info['t'][1] = radians(110)     # Initialising tr in deg
        self.ff_info['d'][1] = 70               # Initialising dr in mm
    ...
    def step(self, action):
        ...
        next_state = np.concatenate((self.ff_info['t'][0],                           # Left Finger Angle
                                     self.ff_info['t'][1],                           # Right Finger Angle
                                     self.obj_pos['x']/200,                          # Obj pos_x
                                     self.obj_pos['y']/200,                          # Obj pos_y
                                     self.goal['x']/200,                             # Goal_x
    ...
    # def get_sub_goal(self):
    #     goal_flag = True
    #     poly = Polygon([(372.05, 245.42), (333.183, 183.196), (180.464, 124.881),(164.79, 194.39)])
    #     min_x, min_y, max_x, max_y = poly.bounds
    #     while (goal_flag):
    #         random_point = Point([random.uniform(min_x, max_x), random.uniform(min_y, max_y)])
    #         if (random_point.within(poly)):
...
class Viewer(pyglet.window.Window):
    ...
    def _update_finger(self):
        ...
        # print('ff_info :', self.ff_info)
        #print('t[0]:', degrees(self.ff_info['t'][0]), ', t[1] : ', degrees(self.ff_info['t'][1]))
