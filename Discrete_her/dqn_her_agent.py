...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # logger
        self.log = logger()
        self.log.add_log('mean_loss')
        self.mean_loss = mean_val()
    ...
    def learn(self, experiences, gamma):
        ...
        # Adding loss to mean calcultaing class
        l = loss.detach().cpu().numpy().astype(float).item(0)
        self.mean_loss.append(l)
...
class HER:
    ...
    def update(self):
        ...
        goal = new_buffer[-1].next_state[2:4]
