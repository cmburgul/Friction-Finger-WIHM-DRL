...
ACTION_SIZE = 5
low = np.array([radians(40), radians(40), 0.5, 0.5, -2.0, -2.0, 0])
high = np.array([radians(140), radians(152), 2.5, 2.5, 2.0, 2.0, 1])

# # Full Workspace 
MAX_OBJ_LIMIT = 95 # in mm
MIN_OBJ_LIMIT = 45  # in mm
LEFT_MAX = 140 # in deg
RIGHT_MIN = 60
RIGHT_MAX = 110
...
class FFenv(gym.Env):
    ...
    def __init__(self):
        ...
        self.ff_info['t'][1] = radians(85)      # Initialising tr in deg
        self.ff_info['d'][1] = 65               # Initialising dr in mm
        ...
        # self.ff_info['t'][0] = radians(40)        # Initialising tl in deg
    ...
    def step(self, action):
        ...
        # print("time_step_i : ", self.time_step_i)
        if (self.time_step_i >= self.time_steps):
            self.episode = self.episode + 1
            if self.episode % 10 == 0:
                print('\rEpisode : ', self.episode)
            self.time_step_i = 0
            self.reset()
