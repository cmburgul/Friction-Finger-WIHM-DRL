...
class FFEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.done = False
        self.ff_info['t'][0] = radians(np.random.randint(70, 90))
        self.ff_info['d'][0] = np.random.randint(75, 100)
        self.ff_info['t'][1], self.ff_info['d'][1] = self.calc_right_config(self.ff_info['t'][0], self.ff_info['d'][0])
...
def callback(_locals, _globals, num_episodes = 20000):
    """
