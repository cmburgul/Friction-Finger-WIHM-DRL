...
class FFEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.ff_info['t'][0] = radians(np.random.randint(70, 110))
        self.ff_info['d'][0] = np.random.randint(35, 100)
        self.ff_info['t'][1], self.ff_info['d'][1] = self.calc_right_config(self.ff_info['t'][0], self.ff_info['d'][0])
        print("Initial start -> d0 : ", self.ff_info['d'][0], "theta_left : ", degrees(self.ff_info['t'][0]))
